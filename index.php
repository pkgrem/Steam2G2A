<?php
  ...
  require 'steamauth/steamauth.php';
      // requires the steam login button for authentication.
...
<html lang="en">
<head>
  <title>Steam G2A Wishlist</title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <? } else {?>
        <li><a href="#"><span class="glyphicon glyphicon-log-in"></span><? echo loginbutton();?> Login</a></li>
      <? } ?>
      </ul>
    </div>
  </div>
